                ...
                <div className="ml-3 relative">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm font-medium text-gray-700">
                      {user?.firstName} {user?.lastName} (Finance)
                    </span>
                  </div>
                </div>
                <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Welcome back, Finance Officer {user?.firstName}!
          </p>
        </div>
                    ...
                    {isLoading ? (
                      ...
                      <div className="text-center py-8">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          No cash advance requests have been submitted yet.
                        </p>
                      </div>
                    ) : (
          ...
          <div className="bg-white shadow rounded-lg">
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Report cards */}
                <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition duration-300 cursor-pointer">
                  <div className="flex items-center">
                    <div className="bg-blue-100 p-3 rounded-full">
                      <FileText className="h-6 w-6 text-blue-600" />
                    </div>
